<?php
class BookSearchAction extends Action {
	public function bookInfo(){
		...
		if(preg_match('/系统号- 图书/', $webdata)){
			...
			preg_match('/<span.*?<\/td>/', $match1[0], $match2);
	...
	public function bookList($booklist){
		print_r($booklist);
	}
}
